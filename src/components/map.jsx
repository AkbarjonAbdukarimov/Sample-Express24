...
const Map = ({ mapState, closeMap, address, setAddress }) => {
    ...
    return <>
        <div className='map-container d-flex justify-content-center align-items-center'>
            <div className="container w-lg-50 mx-2 map p-3">
                ...
                <div>
                    ...
                    <div className="my-2 iframe"> <iframe title='map' className='w-100 h-100' src="https://yandex.com/map-widget/v1/-/CCUvEGHjOC" ></iframe></div>
